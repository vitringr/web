...
function noise(input_triangle_x: number, input_triangle_y: number): number {
  ...
  const dot_A = GRADIENTS_16_I[gradient_index_A].x * delta_A_x + GRADIENTS_16_I[gradient_index_A].y * delta_A_y;
  const dot_B = GRADIENTS_16_I[gradient_index_B].x * delta_B_x + GRADIENTS_16_I[gradient_index_B].y * delta_B_y;
  const dot_C = GRADIENTS_16_I[gradient_index_C].x * delta_C_x + GRADIENTS_16_I[gradient_index_C].y * delta_C_y;
